...
#ifndef ZY_LIB_FACE_IOS_SWIFT_H
#define ZY_LIB_FACE_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="zy_lib_face_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC15zy_lib_face_ios9ZyApiInfo")
@interface ZyApiInfo : NSObject
